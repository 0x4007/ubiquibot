...
export const fromConfig = {
  ...
  getCommentItemPrice: function getCommentItemPriceFromConfig(key: getsCommentElementPricing, { repository, organization }: ImportedConfigurations): CommentElementPricing {
